...
// Unsplash images via the official CDN. These URLs are stable and the
// photographers have all licensed for commercial use under the Unsplash
// license. We use the `?auto=format&fit=crop&w=...` query params to get
// optimized JPEGs at the right size for our cards.
